...
const LANGS = {
  fr: {
    ...
    hero: {
      ...
      sub: 'Une flotte récente, des prix transparents, un service sans faille.\n<span class="hero-deliver">🚗 On vous livre partout — 🏨 hôtel · ✈️ aéroport · 📍 où vous êtes</span>',
  ...
  en: {
    ...
    hero: {
      ...
      sub: 'A recent fleet, transparent prices, flawless service.\n<span class="hero-deliver">🚗 We deliver anywhere — 🏨 hotel · ✈️ airport · 📍 wherever you are</span>',
  ...
  es: {
    ...
    hero: {
      ...
      sub: 'Una flota reciente, precios transparentes, un servicio impecable.\n<span class="hero-deliver">🚗 Te lo entregamos donde sea — 🏨 hotel · ✈️ aeropuerto · 📍 donde estés</span>',
  ...
  ar: {
    ...
    hero: {
      ...
      sub: 'أسطول حديث، أسعار شفافة، خدمة لا تشوبها شائبة.\n<span class="hero-deliver">🚗 نوصّلها لك أينما كنت — 🏨 الفندق · ✈️ المطار · 📍 عندك</span>',
